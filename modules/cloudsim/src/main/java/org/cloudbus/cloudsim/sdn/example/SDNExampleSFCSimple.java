 ...
 */
public class SDNExampleSFCSimple {
		...
		try {
			...
			case MFF:
				vmAllocationFac = new VmAllocationPolicyFactory() {
					public VmAllocationPolicy create(List<? extends Host> hostList) { return new VmAllocationPolicyCombinedMostFullFirst(hostList,null,null); }
				};
			...
			case LFF:
				vmAllocationFac = new VmAllocationPolicyFactory() {
					public VmAllocationPolicy create(List<? extends Host> hostList) { return new VmAllocationPolicyCombinedLeastFullFirst(hostList,null,null); }
				};
				nos = new NetworkOperatingSystemSimple(physicalTopologyFile);
				ls = new LinkSelectionPolicyBandwidthAllocation();
				break;
			case MipMFF:
				vmAllocationFac = new VmAllocationPolicyFactory() {
					public VmAllocationPolicy create(List<? extends Host> hostList) { return new VmAllocationPolicyMipsMostFullFirst(hostList,null,null); }
				};
				nos = new NetworkOperatingSystemSimple(physicalTopologyFile);
				ls = new LinkSelectionPolicyBandwidthAllocation();
				break;
			case MipLFF:
				vmAllocationFac = new VmAllocationPolicyFactory() {
					public VmAllocationPolicy create(List<? extends Host> hostList) { return new VmAllocationPolicyMipsLeastFullFirst(hostList,null,null); }
				};
				nos = new NetworkOperatingSystemSimple(physicalTopologyFile);
				ls = new LinkSelectionPolicyBandwidthAllocation();
				break;
...
//				break;
			...
			if(!SDNExampleSFCSimple.logEnabled) 
				Log.disable();
