...
//			getFreePes().set(idx, getFreePes().get(idx) - requiredPes);
	...
	//TODO change the over ratio to overbooking the host first
	...
	public VmMigrationPolicy getVmMigrationPolicy() {
		return this.vmMigrationPolicy;
	}
	
	// Temporary resource reservation for migration purpose
	// Remove required amount from the available resource of target host
	// [RESERVATION] NOT for the Migration Task resources allocation, just for the VM in target HOST
