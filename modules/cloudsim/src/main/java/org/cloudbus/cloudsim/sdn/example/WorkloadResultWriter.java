...
public class WorkloadResultWriter {
	...
	private static final boolean isPrintDetailSizeTime = false;
	private static final boolean isWriteResultDetail = false; 	// Enable if write detailed result in the file
	private static final boolean isCheckOverTimeRequests = false; 
...
//	}
//	
	List<Double> serveTimeList = new ArrayList<>();
	...
	public void printStatistics() {
		...
		printLine("#======================================");
		//for(double serveTime:this.serveTimeList) {
		//	printLine(String.valueOf(serveTime));
		//}
	}
	...
	private boolean isOverTime(final Workload wl, double serveTime) {
		...
		if(WorkloadResultWriter.isCheckOverTimeRequests) {
