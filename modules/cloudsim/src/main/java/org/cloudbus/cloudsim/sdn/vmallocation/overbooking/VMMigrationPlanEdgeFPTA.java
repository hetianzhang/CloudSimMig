...
public class VMMigrationPlanEdgeFPTA extends VMMigrationPlanning{
	...
	public VMMigrationPlanEdgeFPTA(Map<Vm, VmGroup> vmGroups, List<Map<String, Object>> migrationMapping, SDNDatacenter dataCenter) {
